...
[![License: MIT](https://img.shields.io/badge/License-MIT-7c9cff?style=flat-square)](./LICENSE)
[![Claude Code](https://img.shields.io/badge/Claude%20Code-plugin%20marketplace-5ed6c0?style=flat-square)](https://code.claude.com)
[![Codex](https://img.shields.io/badge/OpenAI-Codex-f7b955?style=flat-square)](https://openai.com/codex)
[![Skills](https://img.shields.io/badge/skills-1-b78bff?style=flat-square)](#-skills)
...
- ▸ **Render a dashboard** — a self-contained, offline HTML view (KPIs, top tools, busiest projects, activity) — aggregates only, no raw prompt text.
