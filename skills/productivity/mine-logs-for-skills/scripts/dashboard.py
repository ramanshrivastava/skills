...
<div class="grid">
  ...
  <div class="panel"><h2>Busiest projects (by prompts)</h2>{bar_rows(proj_prompts, a.top)}</div>
  <div class="panel full"><h2>Activity by month (sessions)</h2>{mhtml}</div>
</div>
<p class="foot">Generated by mine-logs-for-skills · no raw prompt text included.{repo_html}</p>
</div></body></html>"""
